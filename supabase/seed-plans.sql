...
from new_plan np, (values
  (1,'Lower (superset)','lift','1 compound + 3 supersets · ~50-60 min',
    '[{"name":"Warm-up (5 min)","sets":1,"reps":"5 min","cue":"leg swings, bodyweight squats, walking lunges, hip circles - no equipment"},
      ...
      {"name":"C1 · Seated leg curl","sets":3,"reps":"12","cue":"superset C - slow negative"},
      {"name":"C2 · Glute bridge","sets":3,"reps":"15","cue":"superset C - squeeze at the top"},
      {"name":"Core finisher","sets":3,"reps":"~5 min","cue":"plank 30s + bicycle crunch 30s + leg raise 30s · 3 rounds"}]'::jsonb),
  ...
  (3,'Push (superset)','lift','1 compound + 3 supersets · ~50-60 min',
    '[{"name":"Warm-up (5 min)","sets":1,"reps":"5 min","cue":"arm circles, scap push-ups, slow push-ups, shoulder taps - no equipment"},
      ...
      {"name":"C2 · Face pull","sets":3,"reps":"15","cue":"superset C - posture for running"},
      {"name":"Core finisher","sets":3,"reps":"~5 min","cue":"plank 30s + bicycle crunch 30s + leg raise 30s · 3 rounds"}]'::jsonb),
  ...
  (5,'Pull (superset)','lift','1 compound + 3 supersets · ~50-60 min',
    '[{"name":"Warm-up (5 min)","sets":1,"reps":"5 min","cue":"arm circles, band/towel pull-aparts, cat-cow, scap pull-downs - no equipment"},
      ...
      {"name":"C2 · EZ-bar curl","sets":3,"reps":"12","cue":"superset C - controlled"},
      {"name":"Core finisher","sets":3,"reps":"~5 min","cue":"plank 30s + bicycle crunch 30s + leg raise 30s · 3 rounds"}]'::jsonb),
